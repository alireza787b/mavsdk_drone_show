...
GCS_EXPECTED_HTTP = {
    "GET": {
        ...
        "/api/v1/fleet/sidecars/{sidecar}",
        "/api/v1/fleet/sidecars/{sidecar}/baseline",
        "/api/v1/fleet/sidecars/{sidecar}/nodes/{hw_id}",
        "/api/v1/auth/status",
        "/api/v1/auth/me",
        "/api/v1/auth/users",
        "/api/v1/auth/tokens",
        ...
        "/api/v1/system/env/fleet/nodes/{hw_id}",
        "/api/v1/system/sitl/policy",
        "/api/v1/system/sitl/host",
        "/api/v1/system/sitl/images",
        "/api/v1/system/sitl/instances",
        "/api/v1/system/sitl/instances/{instance_name}/logs",
        "/api/v1/system/sitl/operations",
        "/api/v1/system/sitl/operations/{operation_id}",
        "/api/v1/simurgh/audit",
        "/api/v1/simurgh/action-runs",
        "/api/v1/simurgh/action-runs/{run_id}",
        "/api/v1/simurgh/action-runs/{run_id}/events",
        "/api/v1/simurgh/action-runs/{run_id}/events/stream",
        "/api/v1/simurgh/assistant/turns",
        "/api/v1/simurgh/context",
        "/api/v1/simurgh/context/{resource_id}",
        "/api/v1/simurgh/context/{resource_id}/markdown",
    ...
    "POST": {
        ...
        "/api/v1/fleet/sidecars/{sidecar}/policy/apply",
        "/api/v1/fleet/sidecars/{sidecar}/policy/dry-run",
        "/api/v1/fleet/node-boot-status",
        "/api/v1/fleet/sidecars/{sidecar}/promote-draft",
        "/api/v1/fleet/sidecars/{sidecar}/reconcile/apply",
        "/api/v1/fleet/sidecars/{sidecar}/reconcile/dry-run",
        "/api/v1/auth/login",
        "/api/v1/auth/logout",
        "/api/v1/auth/users",
        "/api/v1/auth/tokens",
        ...
        "/api/v1/simurgh/sessions",
        "/api/v1/simurgh/action-runs/{run_id}/controls",
        "/api/logs/frontend",
        "/api/logs/export",
    ...
    "DELETE": {
        "/api/logs/drone/{drone_id}/ulog/downloads/{job_id}",
        "/api/v1/simurgh/provider-credentials",
        "/api/v1/simurgh/sessions/{session_id}",
        "/api/v1/system/sitl/instances/{instance_name}",
...
DRONE_EXPECTED_HTTP = {
    "GET": {
        ...
        "/api/v1/ulog/policy",
        "/api/v1/ulog/files",
        "/api/v1/ulog/files/{log_id}/summary",
