...
DOMAIN_SIGNALS: Mapping[str, tuple[str, ...]] = {
    ...
    "fleet": ("fleet", "drone", "drones", "vehicle", "scout", "ip", "sys_id", "configured", "connected", "telemetry"),
...
DOMAIN_EXPANSIONS: Mapping[str, str] = {
    ...
    "fleet": "fleet drone configuration IP SYS_ID connectivity telemetry presence",
