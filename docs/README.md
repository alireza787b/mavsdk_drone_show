...
| use the Simurgh operator assistant or MCP layer | [Simurgh Operator](guides/simurgh-operator.md) |
...
| Simurgh / MCP reviewer | [Simurgh Operator](guides/simurgh-operator.md) and [Simurgh MCP Client Recipes](guides/simurgh-mcp-clients.md) |
