...
Registry version: `1`
Registry hash: `58860dc9c10d4a71502d4b9fe2a88aed08203498587df82d279f2adb9a75eb4f`
...
| [`MDS_AGENT_OPENAI_MODEL`](#env-mds-agent-openai-model) | agent | agent | string | `gpt-5.4-mini` | yes | gcs | /etc/mds/gcs.env | [guide](../guides/simurgh-operator.md) |
...
- Apply action: `restart_gcs`
- Docs: [guide](../guides/simurgh-operator.md)
- Notes: OpenAI Responses model for advisory assistant text. gpt-5.5 is the latest high-quality option; gpt-5.4-mini is the cost-conscious dashboard default.
