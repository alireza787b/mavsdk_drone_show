...
Registry version: `1`
Registry hash: `d4513846b6d9ab086c4b09892a9cf953124b50a548ae27e265fdcd0eaf20842b`
...
| [`MDS_AGENT_OPENAI_MODEL`](#env-mds-agent-openai-model) | agent | agent | string | `gpt-5.6` | yes | gcs | /etc/mds/gcs.env | [guide](../guides/simurgh-operator.md) |
...
| [`MDS_AGENT_QUERY_ADAPTATION_FILE`](#env-mds-agent-query-adaptation-file) | agent | agent | path | `config/agent_query_adaptation.yaml` | no | gcs | process env | [guide](../guides/simurgh-operator.md) |
...
| [`MDS_ULOG_SUMMARY_TIMEOUT_SEC`](#env-mds-ulog-summary-timeout-sec) | gcs | logging | float | `90` | yes | gcs | /etc/mds/gcs.env | [guide](../guides/logging-system.md) |
...
- Apply action: `restart_gcs`
- Docs: [guide](../guides/simurgh-operator.md)
- Notes: OpenAI Responses model for Simurgh semantic routing and answer composition. gpt-5.6 is the current high-quality dashboard default; deployments may select another compatible model explicitly without changing the workflow.
...
<a id="env-mds-agent-query-adaptation-file"></a>

### `MDS_AGENT_QUERY_ADAPTATION_FILE`

- Title: Simurgh query adaptation config file
- Scope: `agent`
- Domain: `agent`
- Type: `path`
- Default: `config/agent_query_adaptation.yaml`
- Editable: no
- Restart: `gcs`
- Source of truth: `process env`
- Apply action: `restart_gcs`
- Docs: [guide](../guides/simurgh-operator.md)
- Notes: Advanced override for reviewed alias and spelling normalization rules used before Simurgh intent routing. Keep normal edits in config/agent_query_adaptation.yaml.
...
- Apply action: `restart_gcs`
- Docs: [guide](../guides/logging-system.md)
- Notes: Bounded timeout for deriving a sanitized ULog summary through the GCS proxy. Inventory and maintenance requests use the canonical 30-second proxy timeout.
