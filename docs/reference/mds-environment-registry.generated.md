...
Registry version: `1`
Registry hash: `2b61b0144277ef5ead9e36392b662419081ff944f50a696f5dd62e2645a2bd1b`
...
- Docs: [guide](../guides/simurgh-operator.md)
- Allowed values: `True, False`
- Notes: Future action-capable adapters must ask for operator approval before the final executor layer when this is true. If the circuit breaker is also true, approved actions still stop as dry-run/no-execute. Current production slice still exposes advisory-only assistant behavior.
...
- Apply action: `restart_gcs`
- Docs: [guide](../guides/simurgh-operator.md)
- Notes: OpenAI Responses model for advisory assistant text. gpt-5.5 is the current high-quality dashboard default; lower-cost model variants may be selected explicitly when validated for the deployment.
