...
| [`MDS_DEFAULT_SMART_WIFI_MANAGER_REF`](#env-mds-default-smart-wifi-manager-ref) | deployment | connectivity | string | `v2.1.6` | no | manual | deployment/defaults.env | [guide](../guides/connectivity-runtime.md) |
...
| [`MDS_SMART_WIFI_MANAGER_REF`](#env-mds-smart-wifi-manager-ref) | node | connectivity | string | `v2.1.6` | yes | sidecar_reconcile | /etc/mds/local.env | [guide](../guides/connectivity-runtime.md) |
