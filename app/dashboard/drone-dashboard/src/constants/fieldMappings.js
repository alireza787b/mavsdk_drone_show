...
export const FIELD_NAMES = {
  ...
  GPS_RAW_VALID: 'gps_raw_valid',
  GPS_RAW_TIMESTAMP_MS: 'gps_raw_timestamp_ms',
  GPS_RAW_AGE_MS: 'gps_raw_age_ms',
  GPS_RAW_ALTITUDE_M: 'gps_raw_altitude_m',
  LOCAL_POSITION_OK: 'local_position_ok',
  LOCAL_POSITION_NORTH: 'local_position_north',
  LOCAL_POSITION_EAST: 'local_position_east',
  LOCAL_POSITION_DOWN: 'local_position_down',
  LOCAL_POSITION_TIME_BOOT_MS: 'local_position_time_boot_ms',
...
export function getField(drone, fieldKey, defaultValue = undefined) {
  ...
  const legacyMap = {
    ...
    'position_long': ['Position_Long'],
    'position_alt': ['Position_Alt'],
    'distance_to_home_m': ['Distance_To_Home_M', 'distanceToHomeM'],
    'global_position_valid': ['Global_Position_Valid'],
    'global_position_timestamp_ms': ['Global_Position_Timestamp_Ms'],
    'global_position_age_ms': ['Global_Position_Age_Ms'],
    'position_source': ['Position_Source'],
    ...
    'gps_raw_timestamp_ms': ['Gps_Raw_Timestamp_Ms'],
    'gps_raw_age_ms': ['Gps_Raw_Age_Ms'],
    'gps_raw_altitude_m': ['Gps_Raw_Altitude_M', 'GPS_Raw_Altitude_M'],
    'local_position_ok': ['Local_Position_Ok'],
    'local_position_north': ['Local_Position_North'],
    'local_position_east': ['Local_Position_East'],
    'local_position_down': ['Local_Position_Down'],
