...
class Params:
    ...
    SMART_SWARM_POSITION_SOFTENING_M = 4.0
    SMART_SWARM_VERTICAL_SOFTENING_M = 2.0
    ...
    ULOG_DOWNLOAD_REQUIRE_DISARMED = _env_flag("MDS_ULOG_DOWNLOAD_REQUIRE_DISARMED", True)
    ULOG_ERASE_REQUIRE_DISARMED = _env_flag("MDS_ULOG_ERASE_REQUIRE_DISARMED", True)
    ULOG_DOWNLOAD_JOB_TTL_SEC = _safe_float(os.environ.get("MDS_ULOG_DOWNLOAD_JOB_TTL_SEC", "1800"), 1800.0)
    ULOG_DOWNLOAD_MAX_JOBS = _safe_int(os.environ.get("MDS_ULOG_DOWNLOAD_MAX_JOBS", "8"), 8)
    ULOG_DOWNLOAD_STAGE_DIR = os.environ.get("MDS_ULOG_DOWNLOAD_STAGE_DIR", "runtime_data/ulog_downloads")
    ULOG_FILESYSTEM_FALLBACK_DIRS = os.environ.get(
