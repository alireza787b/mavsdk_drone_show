...
- Drone Show runtime validation now treats `/get-position-deviations` as selected-fleet truth instead of full-config truth, so 3-drone acceptance runs no longer abort just because unlaunched config slots are intentionally offline
